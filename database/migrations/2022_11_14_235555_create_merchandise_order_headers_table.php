...
class CreateMerchandiseOrderHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('merchandise_order_headers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('merchandise_order_headers');
    }
}
