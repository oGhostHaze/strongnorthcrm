                        ...
                        <div class="d-flex w-25">
                            ...
                            <div class="col ms-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" placeholder="Search" aria-label="Search" aria-describedby="search" wire:model="search">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{$row->remarks}}</td>
                                        <td><a href="#" class="btn btn-sm btn-danger" onclick="delete_stk('{{$row->stockIn_id}}', '{{$row->stockin_qty}}', '{{$row->product->product_description}}')"><i class="fa-solid fa-x"></i></a></td>
                                    </tr>
                                @empty
