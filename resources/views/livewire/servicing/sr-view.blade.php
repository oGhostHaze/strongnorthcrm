                                ...
                                <tfoot>
                                    <tr class='table-light'>
                                        ...
                                        <td class="text-end"><strong>&#8369;
                                                {{ number_format((float) $servicing->items()->sum('price'), 2) }}</strong>
                                        </td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="text-center fw-bold">RECEIVED BY:</div></br></br>
                                            <div>
                            ...
                            <font size="2" class="mt-0">
                                ...
                                <table class="table table-bordered table-sm m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center">
                                                <span class="py-0 my-0 font-small fw-bolder text-danger">-- Client Copy
                                                    --</span>
                                            </td>
                                        </tr>
                                    </tbody>
