    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <span class="text-uppercase fw-bolder">Supply Location List</span>
                <div class="d-flex w-25">
                    <div class="">
                        <a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">New Location</a>
                    </div>
                    <div class="col ms-2">
        ...
        <div class="card-body">
            ...
            <caption>{{$locations->links()}}</caption>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-2">
                    <span class="input-group-text w-25" id="name">Location</span>
